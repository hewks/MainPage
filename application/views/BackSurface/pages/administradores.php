            ...
            <div class="modal-body">
                <form class="bs-admin-form" id="bs-send-form">
                    <div class="bs-admin-form-group">
                        ...
                        <input type="text" name="username" data-name="Usuario" class="bs-admin-input">
                    </div>
                    <div class="bs-admin-form-group">
                        <label for="password">Contraseña</label>
                        <input type="password" name="password" id="passwordOne" data-name="Contraseña" class="bs-admin-input">
                    </div>
                    <div class="bs-admin-form-group">
                        <label for="password">Contraseña</label>
                        <input type="password" name="password-2" id="passwordTwo" data-name="Contraseña" class="bs-admin-input">
                    </div>
                    <div class="bs-admin-form-group">
